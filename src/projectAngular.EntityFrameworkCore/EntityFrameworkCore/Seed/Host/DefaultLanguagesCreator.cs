...
namespace projectAngular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly projectAngularDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = projectAngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(projectAngularDbContext context)
        {
            _context = context;
        }
