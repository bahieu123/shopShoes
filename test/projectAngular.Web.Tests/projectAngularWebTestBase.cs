...
{
    public abstract class projectAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static projectAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(projectAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<projectAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<projectAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<projectAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<projectAngularDbContext, Task<T>> func)
        {
            T result;
